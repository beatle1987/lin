...
static struct map_desc pangolin_io_desc[] __initdata = {
 /* virtual     physical    length      domain     r  w  c  b */
  { 0xe8000000, 0x00000000, 0x00800000, DOMAIN_IO, 0, 1, 0, 0 }, /* Flash bank 0 */
  { 0xf2400000, 0x10400000, 0x00030000, DOMAIN_IO, 0, 1, 0, 0 }, /* FPGA 0 */
  { 0xf3800300, 0x20000300, 0x00004000, DOMAIN_IO, 0, 1, 0, 0 }, /* SMC91C96 ethernet*/
  LAST_DESC
};
